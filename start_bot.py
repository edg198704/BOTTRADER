...
def validate_config(config: BotConfig):
    ...
    if isinstance(config.strategy.params, AIEnsembleStrategyParams):
        ...
        # This map simulates the simplified column names generated by DataHandler's rename logic.
        # It must be kept in sync with the rename_map in data_handler.py.
        # This provides a crucial pre-flight check.
        ...
        generated_columns = set(indicator_rename_map.values())
